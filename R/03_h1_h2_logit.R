...
estimate_h1_logit <- function(data) {
    ...
    # These use only cinc_a + sidea_winning_coalition_size (no temporal spline)
    # because the sub-type variables have limited variance and adding
    # t + t2 + t3 + cold_war causes separation / non-convergence.
